...
export LD_LIBRARY_PATH=$EXP_FRAMEWORK_PATH/dpdk/dpdk-22.07/dist/lib/x86_64-linux-gnu:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$EXP_FRAMEWORK_PATH/dpdk/dpdk-22.07/dist/lib/:$LD_LIBRARY_PATH
export PKG_CONFIG_PATH=$EXP_FRAMEWORK_PATH/dpdk/dpdk-22.07/dist/lib/x86_64-linux-gnu/pkgconfig:$PKG_CONFIG_PATH
export PATH=$EXP_FRAMEWORK_PATH/dpdk/dpdk-22.07/dist/bin:$PATH
export CPATH=$EXP_FRAMEWORK_PATH/dpdk/dpdk-22.07/dist/include:$CPATH
export C_INCLUDE_PATH=$EXP_FRAMEWORK_PATH/dpdk/dpdk-22.07/dist/include:$C_INCLUDE_PATH
export CPLUS_INCLUDE_PATH=$EXP_FRAMEWORK_PATH/dpdk/dpdk-22.07/dist/include:$CPLUS_INCLUDE_PATH
