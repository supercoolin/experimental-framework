...
export CPATH=$EXP_FRAMEWORK_PATH/llvm/llvm-10.0.1/dist/include:$CPATH
export C_INCLUDE_PATH=$EXP_FRAMEWORK_PATH/llvm/llvm-10.0.1/dist/include:$C_INCLUDE_PATH
export CPLUS_INCLUDE_PATH=$EXP_FRAMEWORK_PATH/llvm/llvm-10.0.1/dist/include:$CPLUS_INCLUDE_PATH
#DPDK VARS
